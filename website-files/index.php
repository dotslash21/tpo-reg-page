...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Welcome to Central Placement Committee(CPC), West Bengal">
    <title>Welcome to CPC,West Bengal
    </title>
          ...
          <ul class="nav navbar-nav pull-right mainNav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a href="./students.html">Important Articles
                  </a>
                </li>
                <li>
                  <a href="#">FAQs
    ...
    <header id="head">
      <div class="container">
        <div class="heading-text">
          <h1 class="animated flipInY delay1">Welcome To
          </h1>
    ...
    <section class="container">
      <div class="row">
        <div class="col-md-8">
          ...
          <a href="./about.html" title="read more" class="btn-inline " target="_self">read more
          </a>
        </div>
        <div class="col-md-4">
          <div class="title-box clearfix ">
            <h2 class="title-box_primary">Notice
            </h2>
          </div>
...
<script type='text/javascript' src='assets/js/fancybox/jquery.fancybox.pack.js'>
</script>
<script type='text/javascript' src='assets/js/jquery.mobile.customized.min.js'>
</script>
<script type='text/javascript' src='assets/js/jquery.easing.1.3.js'>
</script>
<script type='text/javascript' src='assets/js/camera.min.js'>
</script>
<script src="//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js">
</script>
<script src="assets/js/custom.js">
</script>
<script src="./assets/js/index-value.js">
</script>
<script>
  jQuery(function () {
...
<script src="./assets/js/responsive_patch.js">
</script>
<script>
